...
let ResetPasswordEmailService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
...
}, _dec5 = Reflect.metadata("design:type", Function), _dec6 = Reflect.metadata("design:paramtypes", [typeof _IUsersRepository.default === "undefined" ? Object : _IUsersRepository.default, typeof _IUserTokensRepository.default === "undefined" ? Object : _IUserTokensRepository.default, typeof _IHashProvider.default === "undefined" ? Object : _IHashProvider.default]), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = _dec5(_class = _dec6(_class = class ResetPasswordEmailService {
  ...
  async execute({
    ...
    if (!userToken) {
      throw new _AppError.default("User token doesn't exists");
    }

    const user = await this.usersRepository.findById(userToken.user_id);

    if (!user) {
      throw new _AppError.default("User doesn't exists");
    }
...
var _default = ResetPasswordEmailService;
