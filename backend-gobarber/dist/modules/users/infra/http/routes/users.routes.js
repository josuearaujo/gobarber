...
var _enusureAuthenticated = _interopRequireDefault(require("../middlewares/enusureAuthenticated"));
...
usersRouter.patch('/avatar', _enusureAuthenticated.default, upload.single('avatar'), userAvatarController.update);
